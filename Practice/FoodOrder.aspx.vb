...
Public Class FoodOrder
    ...
    Public Sub Button26_Click(sender As Object, e As EventArgs) Handles Button26.Click
    ...
    Protected Sub Button25_Click(sender As Object, e As EventArgs) Handles Button25.Click
        ...
        con.Open()
        cmd = New SqlCommand("Insert into Table2 values('" & TextBox13.Text & "','" & TextBox14.Text & "','" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "','" & TextBox7.Text & "','" & TextBox8.Text & "','" & TextBox9.Text & "','" & TextBox10.Text & "','" & TextBox11.Text & "','" & TextBox12.Text & "')", con)
        ...
        Else
            cmd.ExecuteNonQuery()
            con.Close()
            MsgBox("Moved For Details Phase         Your User-Id is" + TextBox13.Text, MsgBoxStyle.Information, "Success")
    ...
    Public Sub Button27_Click(sender As Object, e As EventArgs) Handles Button27.Click
        ...
        z = (a1 + a2 + a3) * 50 + (a4 + a5) * 100 + (a6) * 80 + (a7 + a8 + a9) * 150 + (a10 + a11 + a12) * 100
