<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FoodOrder.aspx.vb" Inherits="Practice.FoodOrder" %>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="#s1">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  disabled" href="#s1">Food Ordering</a>
                    </li>
                    <li class="nav-item dropdown disabled">
                        <a class="nav-link  dropdown-toggle disabled" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Restaurant Services
                        </a>
                ...
                <form class="d-flex">
                    <a href="practice.aspx" class="btn btn-danger disabled btn-block" type="button">Food-Order</a>
                    &nbsp &nbsp
                ...
                <tbody>
                    <tr>
                        <th scope="row" class="">
                            <span>1.</span>
                            <p>Cholle Bhature</p>
                            <center>  <p Class="text-warning">50 RS.</p>  </center>
                        </th>
                    ...
                    <tr>
                        <th scope="row" class="">
                            <span>4.</span>
                            <p>Fried_Chicken</p>
                            <center>  <p Class="text-warning">100 RS.</p>  </center>
                        </th>
                    ...
                    <tr>
                        <th scope="row" class="">
                            <span>6.</span>
                            <p>Paratha</p>
                            <center>  <p Class="text-warning">80 RS.</p>  </center>
                        </th>
                    ...
                    <tr>
                        <th scope="row" class="">
                            <span>7.</span>
                            <p>Special_Thali</p>
                            <center>  <p Class="text-warning">150 RS.</p>  </center>
                        </th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <br />
                            <br />
                            <asp:Button ID="Button27" runat="server" href="#s1" CssClass="btn-danger" Text="Total Amount" />
                        </td>
                        <td>
                    ...
                    <td>
                        ...
                        <asp:Button ID="Button25" CssClass="btn-danger" runat="server" Text="Click Next For Confirm" OnClientClick="return confirm ('ARE YOU SURE TO CONFIRM  ?? ')" />
                    </td>
